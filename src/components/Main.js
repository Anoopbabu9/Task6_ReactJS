                                        ...
                                        <div class="row text-light">
                                            <div class="col-6 text-center">
                                                <div class="about-info mt-5">
                                                    <p><span className="fs-2">Thulluru Anoop Babu</span></p>
                                                    <p><span className="fs-4">UI/UX Designer</span></p>
                                                    <p><span>@Anoopbabu9</span></p>
                                                    <a className="btn btn-success" href="#contact">Contact Me!</a>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <img src={require("./Anoop.jpeg")} alt="" style={{
                                                    height: "300px",
                                                    padding: "15px",
                                                    display: "block",
                                                    marginLeft: "auto",
                                            ...
                                            <div class="col-12 p-4">
                                                <div class="about-me pt-4 pt-md-0">
                                                    ...
                                                    <p>
                                                    I'm currently pursuing B.TECH in AI & ML in VIT(A.P). My skills
                                                    Programming Languages: C, Java, Designing of User Interface for any app or website. HTML&CSS
                                                    I am interested in designing software that involves new technologies to solve existing problems. Love exploring new technologies like Machine Learning, Data Science.  
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div className="container m-5">
                ...
                <div className="row">
                    <ul className="col-12 col-xxl-6 list-group mt-5 ps-4">
                        ...
                        <li className="list-group-item"><span className="fw-bold">Thulluru Anoop Babu </span></li>
                        <li className="list-group-item"><span className="fw-bold">21st May 2003  </span></li>
                        <li className="list-group-item"><span className="fw-bold">Guntur </span></li>
                    </ul>
                    <ul className="col-12 col-xxl-6 list-group mt-5 pe-4">
                        <li className="list-group-item"><span className="fw-bold">Git Profile: </span><a className="link" href="https://github.com/Anoopbabu9">Click Here</a></li>
